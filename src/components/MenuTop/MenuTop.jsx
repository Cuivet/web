  ...
  function generateVetOptions(vets) {
    ...
    vets.forEach(function eachVet(vet) {
      renderVetOptions.push(
        <Option key={vet.vetData.vet.id}>{vet.vetData.vet.name}</Option>
      );
    });
  ...
  return (
    <div className="menu-top">
      ...
      <div className="menu-top__right">
        {isVet ? (
          <Select placeholder="Clínica" value={vetOptions.key} className="menu-top__right-select">
            {vetOptions}
          </Select>
        ) : null}
