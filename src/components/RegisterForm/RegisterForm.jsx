...
export default function RegisterForm(props) {
    ...
    if (
      ...
      if (!input.mp) {
        return notification["error"]({
          ...
          description:
            "Debe ingresar su matrícula profesional para poder registrarse",
          placement: "top",
        });
      }
    }
  ...
  return (
    <Form className="register-form" onChange={changeForm}>
      ...
      <Form.Item className="register-form__upload">
        <ImgCrop rotate style={{ width: "100%", height: "400px" }}>
          <Dragger
          ...
          >
            ...
            <p className="ant-upload-text">
              {fileList.length < 1 && "Click o arrastra para subir foto"}
            </p>
      ...
      <Form.Item>
        ...
        <Modal
          title={
            isRegistering || catchReason || registeredUser
              ? "Registro de usuario"
          ...
          footer={[
            ...
            catchReason ? (
              registeredUser ? (
                ...
                >
                  {isRegistering ? <Spin></Spin> : <>Reintentar confirmacion</>}
                </Button>
              ) : (
                <Button
                  htmlType="submit"
              ...
              registeredUser.confirmated ? (
                ...
                <Button
                  ...
                  className="register-form_button-ok-modal"
                >
                  {isRegistering ? <Spin></Spin> : <>Confirmar registro</>}
                </Button>
              )
            ) : (
              <Button
                ...
                className="register-form_button-ok-modal"
              >
                {isRegistering ? <Spin></Spin> : <>Aceptar y registrar</>}
              </Button>
            ),
          ]}
        >
          {isRegistering ? (
            <>
              Registrando usuario, este proceso hace algunas validaciones de tus
              datos y por lo tanto puede demorar unos segundos
            </>
          ) : registeredUser ? (
            registeredUser.confirmated ? (
              ...
              <>
                {catchReason ? (
                  ...
                  <>
                    Datos validados correctamente! Se ha enviado un codigo a tu
                    correo electronico, ingresalo a continuación para completar
                    el registro o bien
                  </>
                )}
                <a href="www.google.com"> reenvía el codigo</a> si no lo has
                recibido.
                <div
                  style={{
