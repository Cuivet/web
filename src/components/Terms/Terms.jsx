...
export default function Terms(){
    ...
    return(
        <Collapse ghost accordion>
            <Collapse.Panel header='INFORMACIÓN RELEVANTE' key={'1'}>
                <p>Es requisito necesario para la adquisición de los productos que se ofrecen en este sitio, que lea y acepte los siguientes Términos y Condiciones que a continuación se redactan. El uso de nuestros servicios así como la compra de nuestros productos implicará que usted ha leído y aceptado los Términos y Condiciones de Uso en el presente documento. Todas los productos  que son ofrecidos por nuestro sitio web pudieran ser creadas, cobradas, enviadas o presentadas por una página web tercera y en tal caso estarían sujetas a sus propios Términos y Condiciones. En algunos casos, para adquirir un producto, será necesario el registro por parte del usuario, con ingreso de datos personales fidedignos y definición de una contraseña.
                    ...
                    El usuario puede elegir y cambiar la clave para su acceso de administración de la cuenta en cualquier momento, en caso de que se haya registrado y que sea necesario para la compra de alguno de nuestros productos. www.cuivet.com no asume la responsabilidad en caso de que entregue dicha clave a terceros.
                    ...
                    CUIVET  a través de su sitio web concede una licencia para que los usuarios utilicen  los productos que son vendidos en este sitio web de acuerdo a los Términos y Condiciones que se describen en este documento.
                    
                </p>
            </Collapse.Panel><Collapse.Panel header='USO NO AUTORIZADO' key={'4'}>
                <p> 
        ...
        PROPIEDAD
            ...
            <Collapse.Panel header='POLÍTICA DE REEMBOLSO Y GARANTÍA' key={'2'}>
            ...
            <Collapse.Panel header='COMPROBACIÓN ANTIFRAUDE' key={'3'}>
            ...
            <Collapse.Panel header='PRIVACIDAD' key={'5'}>
                <p> Este www.cuivet.com garantiza que la celta de vigo noticias información personal que usted envía cuenta con la seguridad necesaria. Los datos ingresados por usuario o en el caso de requerir una validación de los pedidos no serán entregados a terceros, salvo que deba ser revelada en cumplimiento a una orden judicial o requerimientos legales.
        
        La suscripción a boletines de correos electrónicos publicitarios es voluntaria y podría ser seleccionada al momento de crear su cuenta.
        
        CUIVET reserva los derechos de cambiar o de modificar estos términos sin previo aviso.</p>
            </Collapse.Panel>
        </Collapse>
