...
export default function PetsManagement() {
	...
	//ESTE TRAE TODAS LAS ASOCIACIONES
	...
	//ACÁ VOY A FILTRAR POR LA VET DEL HEADER
	// function generateData(associations) {
	// 	var finalData = [];
		...
		<>
			...
			<Row gutter={[16, 16]}>
				...
				<Col className="gutter-row" xs={{ span: 24 }} md={{ span: 8 }}>
					<Input
						placeholder={
							selectedVet?.key ? selectedVet.children : "Atención Particular"
						}
						disabled={true}
					/>
				</Col>
